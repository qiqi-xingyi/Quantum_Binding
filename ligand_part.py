...
def main(instance,token):
    ...
    # 9) save result
    final_energy_path = os.path.join("results_projection", "ligand_final_energy.txt")
    ...
    with open("results_projection/ligand_energy.csv","w",newline="") as cf:
        import csv
    ...
    with open("results_projection/ligand_params.json","w") as jf:
        import json

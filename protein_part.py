...
def main(instance,token):
    ...
    # 9) save result
    final_energy_path = os.path.join("results_backup", "protein_final_energy.txt")
    ...
    with open("results_backup/protein_energy.csv", "w", newline="") as cf:
        import csv
    ...
    with open("results_backup/protein_params.json", "w") as jf:
        import json
